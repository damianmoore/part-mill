...
OpenJsCad.Viewer.prototype = {
  ...
  onDraw: function(e) {
    ...
    if (this.drawAxes) {
      ...
      if(1) {
        //X - red
        gl.color(1, 0, 0, 0.5); //negative direction is lighter
        gl.vertex(-200, 0, 0);
        gl.vertex(0, 0, 0);
        ...
        gl.vertex(200, 0, 0);
        //Y - green
        gl.color(0, 1, 0, 0.5); //negative direction is lighter
        gl.vertex(0, -200, 0);
        gl.vertex(0, 0, 0);

        gl.color(0, 1, 0, 1); //positive direction
        gl.vertex(0, 0, 0);
        gl.vertex(0, 200, 0);
         //Z - blue
        gl.color(0, 0, 1, 0.5); //negative direction is lighter
        gl.vertex(0, 0, -200);
        gl.vertex(0, 0, 0);

        gl.color(0, 0, 1, 1); //positive direction
        gl.vertex(0, 0, 0);
        gl.vertex(0, 0, 200);
      }
      if(0) {
    ...
    if (this.boundingBox) {
      ...
      gl.vertex(boundingBox[0][0], boundingBox[0][1], boundingBox[0][2]);
      gl.vertex(boundingBox[1][0], boundingBox[0][1], boundingBox[0][2]);

      gl.vertex(boundingBox[0][0], boundingBox[0][1], boundingBox[0][2]);
      gl.vertex(boundingBox[0][0], boundingBox[1][1], boundingBox[0][2]);

      gl.vertex(boundingBox[0][0], boundingBox[0][1], boundingBox[0][2]);
      gl.vertex(boundingBox[0][0], boundingBox[0][1], boundingBox[1][2]);

      gl.vertex(boundingBox[1][0], boundingBox[1][1], boundingBox[1][2]);
      gl.vertex(boundingBox[0][0], boundingBox[1][1], boundingBox[1][2]);

      gl.vertex(boundingBox[1][0], boundingBox[1][1], boundingBox[1][2]);
      gl.vertex(boundingBox[1][0], boundingBox[0][1], boundingBox[1][2]);
