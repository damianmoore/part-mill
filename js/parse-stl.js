...
ParseStl.ensureBinary = function(buf) {
...
ParseStl.ensureString = function(buf) {
  if (typeof buf !== "string") {
...
ParseStl.isBinary = function(binData) {
...
ParseStl.parseBinary = function(data) {
...
ParseStl.parseASCII = function(data) {
